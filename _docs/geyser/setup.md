...
3. If 2. does not apply: download a jar of Geyser from the [build server](https://ci.opencollab.dev/job/GeyserMC/job/Geyser/job/master/) depending on what platform your server runs on. See the [FAQ](/geyser/faq/#which-plugin-version-of-geyser-do-i-need) if you're confused about which build to download. Keep in mind: Geyser-Spigot.jar is for Spigot and its forks, such as PaperMC or Purpur. 
...
2. Download a jar of Geyser from the [build server](https://ci.opencollab.dev/job/GeyserMC/job/Geyser/job/master/) depending on what platform your server runs on. See the [FAQ](/geyser/faq/#which-plugin-version-of-geyser-do-i-need) if you're confused about which build to download. 
