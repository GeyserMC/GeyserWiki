...
<Questions>
    ...
    <Q>
        ...
        <A>
            ...
            Since Geyser emulates a <Versions platform="java"/> Java Edition client, you need to [install ViaVersion](https://www.spigotmc.org/resources/viaversion.19254/) on your server
