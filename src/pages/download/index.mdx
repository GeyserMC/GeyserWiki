...
<Tabs>
    ...
    <TabItem value="other-projects" label="Other Projects">
        <Collapsibles>
            <Collapsible
                title='GeyserConnect'
                subtitle='A plugin to allow for Geyser players to connect to your server without needing to use a proxy.'
                inner={
                    <ProjectDownload
            ...
            <Collapsible
                ...
                subtitle='An optional Bedrock resource pack to extend Geyser functionality.'
                inner={
                    <ProjectDownload
